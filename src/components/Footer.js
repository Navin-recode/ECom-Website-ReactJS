          ...
          <div className="row align-items-center">
            <div className="col-5">
              <div className="footer-top-data d-flex gap-30 align-item-center">
                <img src="images/images/newsletter.png" alt="newletter" />
          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6 ">
                  Hno: 44 Near Vijay Nagar, <br /> Indore (M.P) <br /> PinCode -
                  452010
                </address>
                <a
                ...
                <a
                  href="mailto:navinkukreja101@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  navinkukreja101@gmail.com
                </a>
            ...
            <div className="col-2">
              ...
              <div className="footer-link d-flex flex-column">
                ...
                <Link className="text-white py-2 mb-1">Samrt Watches</Link>
