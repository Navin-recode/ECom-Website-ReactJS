          ...
          <div className="row">
                  ...
                  <div className="w-100">
                    <div className="d-flex justify-content-between align-items-center">
                      <Link to="/cart" className="text-dark">
                        <BsArrowBarLeft className="me-2" /> Return to Cart
                      </Link>
            ...
            <div className="col-5">
                  ...
                  <div className="w-75 d-flex gap-10">
                    <div className="w-25 position-relative">
                      <span
                        ...
                        className="badge bg-secondary text-white p-2 rounded-circle position-absolute "
                      >
                        1
                      </span>
                    ...
                    <div>
                      <h5 className="total-price">sdfklj</h5>
                      <p className='total-price'>sdlfkj</p>
                    </div>
                  </div>
                  <div className="flex-grow-1">
              ...
              <div className="d-flex justify-content-between align-items-center border-bottom py-4 ">
                ...
                <h5 className='total-price'>$ 3222 </h5>
              </div>
            </div>
          </div>
        </div>
